...
1.  Add text narrative under Exercise 1 in your starter file, explaining briefly why we are able to view `earthquakes` without first using a `read_()` function.
